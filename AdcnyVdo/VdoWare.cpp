...
{
    //DS
    //std::string rtsp1 = "rtsp://admin:sgcs1245@192.168.254.3:554/Streaming/Channels/102";
    //WS
    //std::string rtsp1 = "rtsp://admin:sgcs1245@192.168.254.4:554/Streaming/Channels/102";
    //d-ws
    //std::string rtsp1 = "rtsp://admin:dx7703300@192.168.254.6:554/Streaming/Channels/102";
    //d-ds
    //std::string rtsp1 = "rtsp://admin:dx7703300@192.168.254.7:554/Streaming/Channels/102";
    std::string rtsp1 = spar.imgRoot;
    //cv::VideoCapture cap(spar.imgRoot);
...
void VdoWare::specificRequest(const SorcePar& spar, std::function<void(cv::Mat, int)> f)
{
    ...
    int count = 0;
    //DS
    //cv::VideoCapture cap("rtsp://admin:sgcs1245@192.168.254.3:554/Streaming/Channels/102");
    //WS
    //cv::VideoCapture cap("rtsp://admin:sgcs1245@192.168.254.4:554/Streaming/Channels/102");
    //d-ws
    //cv::VideoCapture cap("rtsp://admin:dx7703300@192.168.254.6:554/Streaming/Channels/102");
    //d-ds
    //cv::VideoCapture cap("rtsp://admin:dx7703300@192.168.254.7:554/Streaming/Channels/102");

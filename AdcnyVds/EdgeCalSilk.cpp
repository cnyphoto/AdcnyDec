...
std::vector<int> EdgeCalSilk::getBigBox(cv::Mat binary, int areaValue, bool r)
{
...
cv::Mat EdgeCalSilk::getdiffNewRow(cv::Mat img, int n, int amplify)
{
...
EdgeCalSilk::EdgeCalSilk(int imgW, int CalSize, int amplify) :imgW(imgW), CalSize(CalSize), amplify(amplify)
{

}

int EdgeCalSilk::edgeTodo(cv::Mat mat, bool lefted, int yStart)
{
	std::vector<int> box1;

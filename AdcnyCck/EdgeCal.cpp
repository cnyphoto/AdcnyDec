...
std::vector<int> EdgeCal::getBigBox(cv::Mat binary, int areaValue, bool r)
{
...
cv::Mat EdgeCal::getdiffNewRow(cv::Mat img, int n, int amplify)
{
...
EdgeCal::EdgeCal(int imgW, int CalSize, int amplify) :imgW(imgW), CalSize(CalSize), amplify(amplify)
{

}

int EdgeCal::edgeTodo(cv::Mat mat, bool lefted, int yStart)
{
	std::vector<int> box1;
